// BootAnimation.h -- "a whole apple gets one bite taken out of it" intro.
//
...
// mask renders "before", "mid-bite" and "after".
#pragma once
#include <M5Unified.h>
#include <stdint.h>
#include "Config.h"
...
class BootAnimation {
 ...
 private:
  enum Phase : uint8_t {
    ...
    PH_GLOW,           // the bitten apple flares white
  ...
  float _appleGlow   = 0.0f;   // 0 = grey, 1 = white
